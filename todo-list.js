...
deleteTodo.forEach((btn)=>{
    btn.addEventListener('click',(e)=>{
        ...
        function runAnimation(){
            todoInner.parentElement.parentElement.classList.add('TodoAni')
        }
        function runDelete(){
...
function renderCompleted(){
    ...
    for(i=0;i<comDelBtns.length;i++){
        ...
        function runAnimationCom(){
           storedCom.parentElement.classList.add('TodoAni')
        }
        function RunDelComo(){
